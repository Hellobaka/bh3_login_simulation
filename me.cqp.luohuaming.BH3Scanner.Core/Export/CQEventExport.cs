...
using me.cqp.luohuaming.BH3Scanner.Core;
using me.cqp.luohuaming.BH3Scanner.Core.Domain;
using me.cqp.luohuaming.BH3Scanner.Sdk.Cqp;
using me.cqp.luohuaming.BH3Scanner.Sdk.Cqp.Enum;
using me.cqp.luohuaming.BH3Scanner.Sdk.Cqp.EventArgs;
using me.cqp.luohuaming.BH3Scanner.Sdk.Cqp.Interface;
using me.cqp.luohuaming.BH3Scanner.Sdk.Cqp.Expand;
using me.cqp.luohuaming.BH3Scanner.Sdk.Cqp.Model;
using Unity;
using Unity.Injection;

namespace me.cqp.luohuaming.BH3Scanner.App.Export
{
	/// <summary>	
	/// 表示酷Q事件导出的类	
	/// </summary>	
	...
	{	
		...
		{	
			return "9,me.cqp.luohuaming.BH3Scanner";	
		}	
		...
		{	
			...
			Type appDataType = typeof (AppData);	
			// 注册一个 CQApi 实例	
			AppInfo appInfo = new AppInfo ("me.cqp.luohuaming.BH3Scanner", 1, 9, "水银扫码机", "1.0.8", 1, "落花茗", "用于对B服的崩坏三进行快捷登录", authCode);	
			...
			AppData.UnityContainer.RegisterInstance<CQLog> ("me.cqp.luohuaming.BH3Scanner", AppData.CQLog);	
